...
public class Launcher {
    ...
    private final static String commandUsage =
            "Usage: java -jar dplp.jar [arguments] <Operation Mode Flag>" + System.lineSeparator() +
                    ...
                    "   -c, --config-file <Path>    Specify an alternate config file (Default ./dplp.conf.xml)" + System.lineSeparator() +
                    "Operation Mode Flags:" + System.lineSeparator() +
                    "   --Standard-DPLP" + System.lineSeparator() +
                    "   --Encrypted-DPLP" + System.lineSeparator();
